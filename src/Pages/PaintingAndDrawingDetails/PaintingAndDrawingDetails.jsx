...
const PaintingAndDrawingDetails = () => {
    ...
    const { photo, item_name, category, price, short_description, rating, processing_time, customization, stock } = paintingAndDrawing;
    return (
        <div className="max-w-7xl mx-auto mt-10 px-10">
            <div className="md:grid grid-cols-2 items-center my-5 pb-5 border-b-8 border-pink-400 rounded-[10%]">
                <img className="md:w-[90%] h-[300px] object-cover rounded-md mx-auto" src={photo} />
                <div className="py-5 flex flex-col gap-2 md:pl-10 items-center md:items-start">
